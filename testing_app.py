...
p.create_personal_event("Wedding","2023-07-29","2023-08-09","Público",addr[0])
p.create_personal_event("Beach","2024-09-1","2024-09-09","Privado",addr[0])
...
p.create_personal_event("Thesis","2024-01-01","2024-01-01","Privado",addr[0])
...
p.create_personal_event("Beach","2023-07-1","2023-07-09","Privado",addr[1])
...
p.create_personal_event("Project","2023-9-1","2023-05-03","Privado",addr[2])
...
p.create_personal_event("Birthday","2023-07-29","2023-08-09","Público",addr[3])
p.create_personal_event("Meeting","2023-10-1","2023-10-09","Privado",addr[3])
p.create_personal_event("Project","2023-10-1","2023-10-03","Privado",addr[3])
...
print(p.get_notifications(addr[random.randint(0,3)]))
