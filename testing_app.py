...
p.create_account("Ist da jemand","Ich weiss nicht","lamoru","bruder",addr[3])
...
assert(p.get_account(1387790852358793275064937372262159359299396267678,"anymore",addr[random.randint(0,3)]) == "Danilo","Perez")
...
assert(p.get_account(1013894169738043364285930992506374634007071297417,"bruder",addr[random.randint(0,3)]) == "Dianelys","Cruz","bruder")
...
assert(p.get_account(46172992780723561320921680056030571120989981024,"bruder",addr[random.randint(0,3)]) == "lopez","bruder")
assert(p.get_account(312739833230340290289372410573930889658287017218,"bruder",addr[random.randint(0,3)]) == "Paula","bruder")
...
assert(p.get_account(7813470691029383468274408971967838198693486436,"bruder",addr[random.randint(0,3)]) == "Ich weiss nicht","lamoru")
assert(p.get_account(531114789999197592597297236183954734558301224076,"bruder",addr[random.randint(0,3)]) == "Ein Man","lopez")
